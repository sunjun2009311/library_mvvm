...
public class ViewAdapter {
    ...
    @BindingAdapter(value = {"onClickCommandWithCode","code"}, requireAll = false)
    public static void onClickCommandWithCode(View view, final BindingCommand<Integer> clickCommand, final int code) {
            RxView.clicks(view)
                    .subscribe(new Consumer<Object>() {
                        @Override
                        public void accept(Object object) {
                            if (clickCommand != null) {
                                clickCommand.execute(code);
                            }
                        }
                    });
