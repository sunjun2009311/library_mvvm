 ...
 */
public abstract class BaseActivity<V extends ViewDataBinding, VM extends BaseViewModel<? extends BaseModel>> extends RxAppCompatActivity implements IBaseView {
    protected V binding;
    ...
    private void initViewDataBinding(Bundle savedInstanceState) {
        ...
        binding = createDataBinding(initContentView(savedInstanceState));
    ...
    private V createDataBinding(int layoutId){
    ...
    protected void registorUIChangeLiveDataCallBack() {
        ...
        viewModel.getUC().getStartActivityWithReqEvent().observe(this, new Observer<Map<String, Object>>() {
            @Override
            public void onChanged(@Nullable Map<String, Object> params) {
                if(params!=null){
                    Class<?> clz = (Class<?>) params.get(ParameterField.CLASS);
        ...
        viewModel.getUC().getFinishWithResultEvent().observe(this, new Observer<Integer>() {
            @Override
    ...
    /**
     * 配合onActivityResult，返回数据到上一个Activity/Fragment
     * @param resultCode
     * @param intent
     */
